      ...
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide slide">
            The starting point of any project is <span class="text-gradient">research</span>. 
            Its main three aspects are user flow, target audience and niche segment of the product.
          </div>
          <div class="swiper-slide slide">
